...
public class MainActivity3 extends AppCompatActivity {
    ...
    private SwitchCompat getContact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isContactChecked = sharedPreferencesCustom.loadIsContactChecked(MainActivity3.this);
        ...
        if(isContactChecked){
            getContact.setChecked(true);
        }else{
            getContact.setChecked(false);
        }
        ...
        getContact.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(getContact.isChecked()){
                    sharedPreferencesCustom.saveData(MainActivity3.this,"isContactEnable",true);
                }
                else{
                    sharedPreferencesCustom.saveData(MainActivity3.this,"isContactEnable",false);
                }
            }
        });
